...
class Usuario(AbstractBaseUser):
    ...
    roles = models.CharField(max_length=10, choices=Roles, default='CLIENTE')
...
class Producto(models.Model):
    ...
    def save(self, *args, **kwargs):
        # Si es un nuevo producto y no tiene creado_por, asignar el usuario actual
        if not self.pk and not self.creado_por and hasattr(self, '_current_user'):
